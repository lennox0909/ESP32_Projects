...
// Courtesy http://www.instruc tables.com/id/How-to-Use-an-RGB-LED/?ALLSTEPS
...
class RGB_HUE {
  ...
  public:
    ...
    RGB_HUE(uint8_t R_pin, uint8_t G_pin, uint8_t B_pin) {
      ledR_pin = R_pin;
      ledG_pin = G_pin;
      ledB_pin = B_pin;

      ledcAttachPin(ledR_pin, 1); // assign RGB led pins to channels
      ledcAttachPin(ledG_pin, 2);
      ledcAttachPin(ledB_pin, 3);
